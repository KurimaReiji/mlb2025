const targetSeasons = [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025];
...
class SeasonSelector extends HTMLElement {
  ...
  dispatch({ season }) {
    ...
    if (!targetSeasons.includes(Number(season))) season = 2025;
...
async function get_today(season) {
  if (Number(season) !== 2025) return Promise.resolve([]);
